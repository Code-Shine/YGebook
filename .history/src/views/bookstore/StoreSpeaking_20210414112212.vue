<template>
  <div class="book-speaking">
    <speaking-title @back="back" ref="title"></speaking-title>
    <scroll class="content-wrapper"
      ...
      <!-- <book-info :cover="cover"
        ...
        <div class="banner-wrapper">
            <img class="banner-img" src="../../assets/images/play1.jpg"  alt="科大讯飞" />
        </div>
...
<script type="text/ecmascript-6">
  import SpeakingTitle from '../../components/detail/SpeakingTitle'
  ...
  import { download, flatList, downloadMp3 } from '../../api/store'
  ...
  export default {
    ...
    methods: {
      createVoice(text) {
        ...
        // // console.log('der1') 可以显示，所以是send()方法出现了问题，在这里是同步的方法
        // xmlhttp.send()
