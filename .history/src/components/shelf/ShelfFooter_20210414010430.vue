  ...
  <div class="shelf-footer" v-show="isEditMode">
    <div class="shelf-footer-tab-wrapper" v-for="item in tabs"
      ...
      <div class="shelf-footer-tab" :class="{'is-selected': isSelected}">
        ...
        <div class="icon-book2 tab-icon" v-if="item.index === 3"></div>
...
import { saveBookShelf, removeLocalStorage, clearLocalStorage } from '../../utils/localStorage'
import { download } from '../../api/store'
import { removeLocalForage, clearLocalForage } from '../../utils/localForage'
   ...
   async setDownload() {
    ...
    showRemove() {
      ...
      // }
        ...
        this.popupMenu = this.popup({
          title: this.$t('shelf.clearAllTitle'),
          btn: [
            {
