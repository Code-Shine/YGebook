const messages = {
    ...
    category: {
        ...
        literature: '文学',
        biomedicine: '医药学',
        businessandManagement: '管理学',
        earthSciences: '地球学',
        materialsScience: '材料学',
        mathematics: '数学',
        medicineAndPublicHealth: '卫生学',
        philosophy: '哲学',
        physics: '物理学',
        politicalScienceAndInternationalRelations: '关系学',
        psychology: '心理学',
        statistics: '统计学'
    },
    shelf: {
        ...
        clearAllTitle: '是否确认清空全部书籍？',
        delete: '删除',
        clearCache: '清空',
        clearCacheSuccess: '缓存已清空',
        removeBookTitle: '是否确定将选中书籍移出书架？',
        removeBook: '移出',
        selectedBooks: '所选书籍',
        default: '默认',
        progress: '按进度',
